      ...
      <div className="mx-auto w-4/5">
        <div>
          <nav className="relative">
            <div className="flex items-center gap-10">
              <Link
                ...
                className={`hover:text-fuchsia-700 ${
                  activeTab === "personalInfo" ? `text-fuchsia-700` : ``
                }`}
              ...
              <Link
                to="#"
                className={`hover:text-fuchsia-700 ${
                  activeTab === "changePassword" ? `text-fuchsia-700` : ``
                }`}
            ...
            <div
              className={`absolute mt-2 h-1 bg-fuchsia-600 transition-all duration-300 ${
          ...
          <div className="flex flex-col mx-auto lg:flex-row mt-14 gap-5">
            ...
            <div className="mt-3 mx-auto lg:mx-0">
              <h1 className="text-3xl mb-2 text-center lg:text-start font-medium">
